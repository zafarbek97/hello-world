"""davlat = {"davlat": "O'zbekiston", "poytaxt": "Toshkent", "til": "O'zbek tili"}
print(davlat)
print(type(davlat))
print(davlat["poytaxt"])
print(davlat["til"]) 
print(davlat["davlat"])"""
...
if natija:
	print("Xalqaro nomi: ", natija["name"])
	print("Poytaxt: ", natija["capital"])
	print("Pul birligi: ", natija["currency"])
	print("Tillar: ", natija["languages"])
	print("Telefon kodi: ", natija["phone"])
else:
